...
const InteractivePractice = () => {
  ...
  const getCounterMessage = (clickCount: number): string => {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md" style={{ backgroundColor: bgColor }}>
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 border rounded bg-white/80">
        ...
        <button 
          onClick={resetAll}
          className="w-full py-2 bg-gray-500 text-white rounded hover:bg-gray-600 transition-colors duration-200 font-semibold"
        >
          🔄 Reset Everything
        </button>
      </div>
